...
(async function fn() {
    ...
    // }
let value=await page.evaluate(function(element){return element.textContent},element);
   ...
   // await page.waitFor(3000);//sayad koi video live hongi isliye last video print nhi hui\
